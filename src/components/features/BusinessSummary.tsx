...
const BusinessSummary = ({ summary }: BusinessSummaryProps) => {
  ...
  return (
    ...
    >
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-gray-800 mb-3">{t('businessSummary.overview.title')}</h3>
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 relative">
          ...
          <button 
            ...
            title={t('businessSummary.copyToClipboard')}
          >
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        <div>
          <h3 className="text-xl font-semibold text-gray-800 mb-3">{t('businessSummary.uniqueSellingPoints.title')}</h3>
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800 mb-3">{t('businessSummary.servicesProducts.title')}</h3>
          <ul className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-2 relative">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <h3 className="text-xl font-semibold text-gray-800 mb-3">{t('businessSummary.brandVoice.title')}</h3>
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 relative">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800 mb-3">{t('businessSummary.valuePropositions.title')}</h3>
          <ul className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-2 relative">
